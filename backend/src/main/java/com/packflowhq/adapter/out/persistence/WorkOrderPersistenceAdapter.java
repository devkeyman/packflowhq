...
import com.packflowhq.adapter.out.persistence.repository.WorkOrderRepository;
import com.packflowhq.application.port.out.WorkOrderPort;
import com.packflowhq.common.mapper.WorkOrderMapper;
...
public class WorkOrderPersistenceAdapter implements WorkOrderPort {
    ...
    public WorkOrderModel save(WorkOrderModel workOrder) {
        com.packflowhq.adapter.out.persistence.entity.WorkOrder entity = workOrderMapper.toEntity(workOrder);
        com.packflowhq.adapter.out.persistence.entity.WorkOrder saved = workOrderRepository.save(entity);
