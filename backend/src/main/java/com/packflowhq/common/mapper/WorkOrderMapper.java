...
import com.packflowhq.adapter.out.persistence.entity.enums.SupplyType;
import com.packflowhq.adapter.out.persistence.entity.enums.WorkType;
import com.packflowhq.common.dto.workorder.WorkOrderDto;
import com.packflowhq.domain.model.Priority;
import com.packflowhq.domain.model.WorkOrderModel;
import com.packflowhq.domain.model.WorkStatus;
...
public class WorkOrderMapper {
    ...
    private void mapDomainToEntityEnums(WorkOrderModel domain, WorkOrder entity) {
        ...
        entity.setPriority(domain.getPriority() != null
            ? com.packflowhq.adapter.out.persistence.entity.enums.Priority.valueOf(domain.getPriority().name())
            : com.packflowhq.adapter.out.persistence.entity.enums.Priority.MEDIUM);
        entity.setStatus(domain.getStatus() != null
            ? com.packflowhq.adapter.out.persistence.entity.enums.WorkStatus.valueOf(domain.getStatus().name())
            : com.packflowhq.adapter.out.persistence.entity.enums.WorkStatus.PENDING);
